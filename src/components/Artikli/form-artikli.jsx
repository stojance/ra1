            ...
            <div className="form-horizontal">
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label" htmlFor="sifra">
                    Шифра
                  </label>
                </div>
              ...
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label" htmlFor="naziv">
                    Назив
                  </label>
                </div>
                <div className="col-md-10">
              ...
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label" htmlFor="skraten">
                    Скратен назив
                  </label>
                </div>
                <div className="col-md-10">
              ...
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label" htmlFor="edm">
                    Едм
                  </label>
                </div>
                <div className="col-md-10">
              ...
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label" htmlFor="grupa">
                    Група
                  </label>
                </div>
                <div className="col-md-10">
              ...
              <div className="form-group row">
                <div className="col-md-2">
                  <label className="control-label">Данок</label>
                </div>
                <div className="col-md-10">
                  <select
                    className="form-control form-control-sm"
              ...
              <div className="form-group row">
                ...
                <button
                  type="submit"
                  ref="submit"
                  className="btn btn-sm btn-success col-md-4"
                >
                  <i className="fa fa-save" /> Сними
                </button>
                <div className="col-md-4" />
              </div>
            </div>
