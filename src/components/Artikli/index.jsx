...
class Artikli extends Component {
  ...
  getArtikliUrl() {
    ...
    if (this.state.queryOptions && this.state.queryOptions.TotalPages > 0) {
      console.log(
        Config.artikliGet() +
          "?" +
          Config.objToQueryString(this.state.queryOptions)
      );
      return (
        Config.artikliGet() +
        "?" +
  ...
  fetchArtikli() {
    ...
    console.log(this.getArtikliUrl());
    axios
      .get(this.getArtikliUrl())
      .then((res) => {
        console.log(res);
        console.log(res.data);
        this.setState({
          isLoaded: true,
          queryOptions: res.data.QueryOptions,
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-1">
              <button
                onClick={this.handleAddArtikalClick}
          ...
          <div className="row">
            <div className="col-md-6">
              <PageDown
                handleClick={this.handlePageDown}
                isDisabled={this.state.queryOptions.CurrentPage === 1}
              />
            </div>
            <div className="col-md-6">
              <PageUp
                handleClick={this.handlePageUp}
                isDisabled={
                  this.state.queryOptions.CurrentPage ===
                  this.state.queryOptions.TotalPages
                }
              />
            </div>
          </div>
